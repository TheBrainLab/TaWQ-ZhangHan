...
# Model detail
parser.add_argument('--model', default='spikingformer_tawq', type=str, metavar='MODEL',
...
def main():
    ...
    dataset_train = create_dataset(
        args.dataset, download=True, 
        root=args.data_dir, split=args.train_split, is_training=True,
        batch_size=args.batch_size, repeats=args.epoch_repeats)

    dataset_eval = create_dataset(
        args.dataset, download=True,  root=args.data_dir, split=args.val_split, is_training=False, batch_size=args.batch_size)
